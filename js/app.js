            ...
            function inputs_init(inputs) {
                if (inputs.length > 0) for (let index = 0; index < inputs.length; index++) {
                    ...
                    input.addEventListener("focus", (function(e) {
                        ...
                        if ("pass" === input.getAttribute("data-type")) input.setAttribute("type", "password");
                    ...
                    input.addEventListener("blur", (function(e) {
                        if ("" == input.value) {
                            ...
                            if (input.classList.contains("_mask")) input_clear_mask(input, input_g_value);
                            if ("pass" === input.getAttribute("data-type")) input.setAttribute("type", "text");
                        }
                    }));
                    if (input.classList.contains("_date")) datepicker(input, {
